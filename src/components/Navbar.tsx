    ...
    <header className="shadow mb-2 bg-white">
      <div className="relative flex max-w-screen-xl flex-col overflow-hidden px-4 py-4 md:mx-auto md:flex-row md:items-center">
        ...
        >
          ...
          <span className="text-blue-500">The Future Store</span>
        </a>
        <input type="checkbox" className="peer hidden" id="navbar-open" />
        <label
          className="absolute top-5 right-7 cursor-pointer md:hidden bg-blue-600"
          htmlFor="navbar-open"
        >
        ...
        >
          <ul className="flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
            <li className="text-gray-600 md:mr-12 hover:text-blue-600 text-md">
              <NavLink to="/" className="px-3 py-2 duration-100 ">
                Home
              </NavLink>
            </li>
            <li className="text-gray-600 md:mr-12 hover:text-blue-600 text-md">
              <NavLink to="/price" className="px-3 py-2 duration-100 ">
                Pricing
              </NavLink>
            </li>
            <li className="text-gray-600 md:mr-12 hover:text-blue-600 text-md">
              <NavLink to="/features" className="px-3 py-2 duration-100 ">
                Features
              </NavLink>
            </li>
